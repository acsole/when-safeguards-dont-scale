...
|------|----------------|---------------------|
| **Human authority** | **Decides and has the final say for decision-making**. Approves or rejects plans before execution. Sets strategic direction. Acts as guardian of the project's ethics and constraints. | Execute without reviewing. Delegate high-risk decisions. Assume a proposal is correct without questioning it. |
